...
{
	static IndexedModel power_star_body = OBJParser.parseTriangleMesh("power_star_body");
	static IndexedModel power_star_eyes = OBJParser.parseTriangleMesh("power_star_eyes");
