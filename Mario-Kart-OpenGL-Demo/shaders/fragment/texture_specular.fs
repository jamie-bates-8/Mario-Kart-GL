...
{ 
    ...
    vec4 specular_intensity = texture2D(specular_map, gl_TexCoord[0].st);
             						         
	vec4 linearColor = shadowCoefficient * (textureColor * (ambient + diffuse) + specular * specular_intensity);
